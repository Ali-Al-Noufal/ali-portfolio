...
const AdminShowProject = () => {
    ...
    const navigate=useNavigate()     
      ...
      useEffect(()=>{
        axios.get(`https://ali-al-noufal.vercel.app/api/api/projects/${params.id}`,{
          headers:{
        ...
        axios.post(`https://ali-al-noufal.vercel.app/api/api/projects/${params.id}`,{...data,"_method":"PUT"},{
          headers:{
            "Accept":"application/json",
