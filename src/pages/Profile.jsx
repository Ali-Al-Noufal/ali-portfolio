...
const Profile = () => {
      ...
      const handleForm=(event)=>{
        ...
        axios.post("https://ali-al-noufal.vercel.app/api/api/user/1/edit",{...data,"_method":"PUT"},{
          headers:{
            "Accept":"application/json",
  ...
  return (
    <div className=" flex flex-col items-center gap-10 ">
        ...
        <form className="w-[80vw] lg:w-200 h-350 flex flex-col items-center gap-10 bg-[#F1F4F9] mt-20 border-2 rounded-3xl " onSubmit={handleForm}>
            ...
            <input type="password" placeholder="password_confirmation" className="bg-[#FFFFFF] border w-[60%] h-15 rounded-2xl px-3"
