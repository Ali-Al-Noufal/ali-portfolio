...
const navigate=useNavigate()
      useEffect(()=>{
        axios.get("https://ali-al-noufal.vercel.app/api/api/skills",{
          headers:{
      ...
      const editSkill=(id)=>{
        ...
        axios.post(`https://ali-al-noufal.vercel.app/api/api/skills`,data,{
          headers:{
            "Accept":"application/json",
...
.catch(err=>console.log(err))
      ...
      const deleteSkill=(id)=>{
          axios.delete(`https://ali-al-noufal.vercel.app/api/api/skills/${id}`,{
          headers:{
            "Accept":"application/json",
            'Content-Type':"application/json",
            Authorization:localStorage.getItem("token")
